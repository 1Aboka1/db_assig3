...
class Address(models.Model):
    member_user = models.OneToOneField('Member', models.DO_NOTHING, primary_key=True)
...
class Appointment(models.Model):
    ...
    caregiver_user = models.ForeignKey('Caregiver', models.DO_NOTHING)
    member_user = models.ForeignKey('Member', models.DO_NOTHING)
...
class Caregiver(models.Model):
    caregiver_user = models.OneToOneField('User', models.DO_NOTHING, primary_key=True)
...
class Member(models.Model):
    member_user = models.OneToOneField('User', models.DO_NOTHING, primary_key=True)
